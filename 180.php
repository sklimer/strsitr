...
$target_length = 1800; // длина в миллиметрах

// Получаем все активные товары с длиной 180 см
...
<head>
  <meta charset="UTF-8">
  <title>Ванны акриловые 180 см купить в Стерлитамаке — каталог ванн</title>
  <meta name="description" content="В каталоге ванн представлены акриловые гидромассажные ванны с длиной 180 см по выгодным ценам в Стерлитамаке.">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="robots" content="index, follow">
  <meta name="generator" content="">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="theme-color" content="#2b58cc">
  <link rel="canonical" href="https://str.city/vanny-akrilovye/180">
   ...
   <div class="container">
      <div class="row justify-content-md-center">
         <div class="mbr-white col-md-12">
            <h1 class="mbr-section-title align-center mbr-bold pt-3 pb-3 mbr-fonts-style display-1" style="font-size: 3.75rem;">Акриловые ванны 180 см в Стерлитамаке</h1>
         ...
         <div class="mbr-white col-md-10">
            <div class="color-the-die pt-2">
               <h3 class="mbr-section-subtitle align-center mbr-light pb-2 mbr-fonts-style display-2">Купите акриловую ванну Тритон® длиной 180 см и она станет жемчужиной вашей ванной комнаты.</h3>
            </div>
    ...
    <div class="container">
        <p class="display-7" style="padding-left: 15px;" itemscope itemtype="https://schema.org/BreadcrumbList">
            ...
            <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                ...
                <span itemprop="name">180 см</span>
        ...
        <div class="media-container-row pt-0 link-blocks">
            <div class="link-block">
                ...
                <div class="link-subblock">
                    ...
                    <a href="#" class="link-block__link current">180</a>
                </div>
            </div>
            <div class="link-block">
                <div class="link-toggler">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-12 mbr-fonts-style display-6">
                ...
                <p class="display-4 pt-2">В магазине &laquo;<a href="/">СтройСити</a>&raquo; в Стерлитамаке можно купить ванны известного завода &laquo;Тритон&raquo;. Продукция фирмы славится надежностью каркаса, износоустойчивостью и безопасностью антибактериального покрытия.</p>
                <p>В коллекции акриловых ванн длиной 180 см есть классические модели и изделия нестандартной формы с большим набором дополнительных функций.</p>
                <h2 class="pt-3">Предложения каталога</h2>
                <ul>
                    <li>Ванна &laquo;Мишель&raquo; отличается интересной асимметричной формой и округлыми линиями, оснащена удобной спинкой и углублениями для рук. Она сочетает стандартные габариты с рекордной вместимостью. В чашу входит почти 400 литров воды. Модель представлена в двух вариантах с правым и левым расположением торцевой стенки.</li>
                    <li>&laquo;Цезарь&raquo; &ndash; прямоугольная акриловая ванна длиной 180 см. Ее можно поставить в&nbsp;любом месте комнаты: у окна, у стены или в центре. Внутреннее пространство позволяет вытянуться во весь рост во время купания, удобно расположить руки и&nbsp;ноги на специальных подставках.</li>
                </ul>
                <p>У нас можно приобрести дополнительное оборудование, которое превратит ванну в&nbsp;домашнюю spa-студию. Чтобы получить дополнительную информацию по&nbsp;ассортименту и условиям доставки, звоните <a href="tel:+73473201102" rel="nofollow">+7(3473)20-11-02</a>.</p>
            </div>
        </div>
    </div>
</section>
