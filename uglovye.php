...
// Получаем все активные товары, где bath_type содержит "Углов" или "Асимметричн" (включая опечатки)
$stmt = $pdo->query("SELECT * FROM NewVanna WHERE active = 1 AND (bath_type LIKE '%Углов%' OR bath_type LIKE '%Асимметричн%' OR bath_type LIKE '%Ассиметричн%') ORDER BY id");
...
<head>
    <meta charset="UTF-8">
    <title>Угловые ванны акриловые купить в Стерлитамаке — каталог ванн</title>
    <meta name="description" content="В каталоге представлены угловые акриловые гидромассажные ванны. Ванны имеют разные размеры и выгодно отличающие цены.">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://str.city/vanny-akrilovye/uglovye">
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-12">
                <h1 class="mbr-section-title align-center mbr-bold pt-3 pb-3 mbr-fonts-style display-1">Угловые акриловые ванны в Стерлитамаке</h1>
...
<section class="features18 popup-btn-cards catalog1">
    <div class="container">
        ...
        <p class="display-7" style="padding-left: 15px;">Последнее изменение <?php echo date("d.m.Y"); ?> — своевременное обновление информации.<br>Каталог с ценами на акриловые ванны актуален сегодня <?php echo date("d.m.Y"); ?>, в наличии <?php echo count($mainProducts); ?> форм ванн — это прямоугольные, асимметричные, угловые. Разные стили исполнения — это классические, элегантные, оригинальные, стандартные. Представленные в каталоге ванны выполнены из акрила.</p>
        ...
        <div class="media-container-row pt-0 link-blocks">
            ...
            <div class="link-block">
                ...
                <div class="link-subblock">
                    ...
                    <a href="/vanny-akrilovye/uglovye" class="link-block__link current">Угловые</a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-12 mbr-fonts-style display-6">
                <!-- Статический текст из оригинального файла uglovye.php -->
                ...
                <p>Желающих купить угловую ванну нередко останавливают высокая цена и&nbsp;внушительные габариты. На самом деле чаша, расположенная в углу помещения, занимает не так много площади и может поместиться даже в комнате скромных размеров. Ассортимент угловых акриловых ванн в нашем магазине позволит подобрать подходящую под ваш проект сантехнику.</p>
                <p>В каталоге &laquo;<a href="https://str.city/">СтройСити</a>&raquo; представлена продукция завода &laquo;Тритон&raquo;, который больше 20 лет выпускает <a href="/vanny-akrilovye/">ванны из акрила</a>. Изделия этой марки славятся идеальной эргономикой, изготавливаются по уникальной технологии, могут эксплуатироваться больше 25 лет.</p>
                <h2>Угловая акриловая ванна: преимущества</h2>
                <p>Ванны с установкой в углу помещения привлекают оригинальным дизайном и разнообразием форм. Они бывают компактными и объемными, треугольными и трапециевидными, равнобедренными и асимметричными.</p>
                <p>Малый вес акриловых ванн облегчает транспортировку и установку габаритной конструкции. Противоскользящее антисептическое покрытие обеспечивает комфорт и&nbsp;безопасность при использовании. Сегодня можно купить угловую ванну с&nbsp;подставкой для ног, сидением, подголовником, оборудованием для дополнительных функций:</p>
                <ul>
                    <li>аэромассажа;</li>
                    <li>контроля за температурой и уровнем воды;</li>
                    <li>регуляции мощности напора;</li>
                    <li>ароматерапевтических процедур;</li>
                    <li>автоматической очистки чаши;</li>
                    <li>подсветки.</li>
                </ul>
                <p>У нас вы можете выбрать классическую ванну со строгими формами или оригинальную с замысловатыми изгибами, стандартную чашу или мини-джакузи. Менеджеры магазина всегда готовы проконсультировать по ассортименту и помочь с&nbsp;оформлением заказа.</p>
                <p>Звоните <a href="tel:+73473201102" rel="nofollow">+7(3473)20-11-02</a>.</p>
            </div>
        </div>
    </div>
</div>
