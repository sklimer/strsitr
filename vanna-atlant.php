          ...
          <table class="table"  >
            ...
            <tbody>
             <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="В зависимости от модели ванны, подголовник может представлять собой мягкую полиуретановую подушку или удобный, поставленный на ножки, валик. Для ванны «Атлант» подходит подголовник «мягкая полиуретановая подушка» без ножек, а вот по количеству, их можно поставить и 2 шт."><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> <a class="text-info" href="#additional_equipment_bath">Подголовники</a></td>
              ...
              <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="Торцевой экран предназначен для установки с торцевой стороны ванны, если вы хотите закрыть пространство под ванной от посторнних глаз не только с фронтальной части, но и с боковой. Обратите внимание, что торцевой экран для ассиметричных ванн изготовляется и устанавливается на узкую сторону! В магазине «СтройСити» есть 2 варианта торцевого экрана. Подробности о стоимости уточняйте у менеджера."><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> Экран торцевой</td>
              <td class="body-item mbr-fonts-style display-7">1</td>
...
Предлагаем вашему вниманию, прямоугольную ванну «Атлант», из коллекции элегантных ванн «Тритон». <strong>Акриловая ванна «Атлант»</strong> самая большая ванна в своём классе. Длина ванны составляет 205 см, а ширина 120 см — это целое море объёмом 600 литов, в котором можно купаться и наслаждаться отдыхом, и чудесным массажем. Эта ванна отличается поистине большим размером. В ней будет идеально удобно высоким людям и тем, кто не любит скучать в одиночестве. <a href="" class="spoilers_links" style="border-bottom: 1px dotted #4d90fe;">Показать ещё</a>
...
<section class="video-cont mbr-fullscreen mbr-parallax-background" id="header13-12" style="background-image: url(../../../assets/images/vanna/bg-vanna-akrilovaya-atlant-video.jpg);">
 <div class="container">
 ...
 <div class="modalWindow-container">
  <div class="modalWindow-video-container">
   <div class="modalWindow-video">
    <iframe width="100%" height="100%" frameborder="0" allowfullscreen="1" data-src="https://www.youtube.com/watch?v=Ky8lDD3XN9E"></iframe>
    </div>
