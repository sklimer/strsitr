...
$target_length = 1500; // длина в миллиметрах

// Получаем все активные товары с длиной 150 см
...
<head>
  <meta charset="UTF-8">
  <title>Акриловые ванны 150 см купить в Стерлитамаке — СтройСити</title>
  <meta name="description" content="В каталоге представлен большой выбор акриловых гидромассажных ванн с длиной 150 см по выгодным ценам.">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="robots" content="index, follow">
  <meta name="generator" content="">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="theme-color" content="#2b58cc">
  <link rel="canonical" href="https://str.city/vanny-akrilovye/150">
   ...
   <div class="container">
      <div class="row justify-content-md-center">
         <div class="mbr-white col-md-12">
            <h1 class="mbr-section-title align-center mbr-bold pt-3 pb-3 mbr-fonts-style display-1" style="font-size: 3.75rem;">Акриловые ванны 150 см в Стерлитамаке</h1>
         ...
         <div class="mbr-white col-md-10">
            <div class="color-the-die pt-2">
               <h3 class="mbr-section-subtitle align-center mbr-light pb-2 mbr-fonts-style display-2">Купите акриловую ванну Тритон® длиной 150 см и она станет жемчужиной вашей ванной комнаты.</h3>
            </div>
        ...
        <div class="media-container-row pt-0 link-blocks">
            <div class="link-block">
                ...
                <div class="link-subblock">
                    ...
                    <a href="#" class="link-block__link current">150</a>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-12 mbr-fonts-style display-6">
                ...
                <p class="display-4 pt-2">В магазине &laquo;<a class="text-primary" href="/">СтройСити</a>&raquo;, официального дилера марки &laquo;Тритон&raquo; в Стерлитамаке, большой выбор акриловых ванн длиной 150 см. ТМ Triton выпускает сантехнику и&nbsp;мебель с акриловым покрытием больше 20 лет. Производитель применяет уникальные технологии, а качество готовых изделий проверяет с учетом 36 параметров.</p>
                ...
                <ul style="margin-bottom: 1rem;">
                    <li>Классические <a class="text-primary" href="/vanny-akrilovye/pryamougolnye">прямоугольные</a> &ndash; надежные и проверенные временем. Они подходят для комфортного размещения людей среднего роста, удобны для купания малышей и ручной стирки. Ширина чаши 70-75 см позволяет дотянуться до любого угла при чистке и мойке покрытия.</li>
                    <li>Треугольные акриловые ванны со сторонами 1500 мм подходят для просторных помещений. Большинство моделей оснащается дополнительным оборудованием. Это могут быть устройства для гидромассажа и ароматерапии, регуляторы напора, температурные датчики или подсветка.</li>
                    <li>Если размеры комнаты не позволяют установить большую треугольную акриловую ванну, подойдет асимметричная длиной 150 см. Такая конструкция оставляет место для полочек, полотенцесушителей, шкафов, стиральных машин и сушилок для белья.</li>
                </ul>
                <p class="pt-3">Чтобы купить ванну 150 см со скидкой, оформите заказ на сайте. Если нужна профессиональная помощь, звоните <a class="text-primary" href="tel:+73473201102" rel="nofollow">+7(3473)20-11-02</a>.</p>
            </div>
        </div>
    </div>
</section>
