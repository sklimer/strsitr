...
$query = mysql_query("SELECT * FROM `video-bez-oborudovaniya` ORDER BY `id` DESC LIMIT 10") or die(mysql_error()); $video = ''; 
while ($data = mysql_fetch_assoc($query)) $video .= $data['text'].'';
